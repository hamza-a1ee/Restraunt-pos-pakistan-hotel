...
export default function DishTable({
  ...
  const columns: ColumnDef<ICusine>[] = [
    {
    ...
    {
      header: () => <TableHead>Price</TableHead>,
      accessorKey: "totalDishes",
      cell: ({ row }) => <CellValue>{row.original.price}</CellValue>,
    },
  ...
  return (
    <div className="flex w-full">
      <DataTable
        columns={columns}
        data={dishes?.dishes as ICusine[]}
        metaData={dishes?.meta}
        limit={limit}
        total={page}
        setTotal={setLimit}
